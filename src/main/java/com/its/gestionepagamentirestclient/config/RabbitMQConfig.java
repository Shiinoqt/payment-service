...
public class RabbitMQConfig {
    ...
    public static final String PAYMENT_RECEIPT_QUEUE = "queue-payment-receipt-updated";
    ...
    public Queue paymentReceiptQueue() {
        return new Queue(PAYMENT_RECEIPT_QUEUE, true);
    }
    ...
    @Bean
    public Binding paymentReceiptBinding() {
        return BindingBuilder.bind(paymentReceiptQueue())
                .to(paymentReceiptExchange())
                .with(PAYMENT_RECEIPT_ROUTING_KEY);
    }
